...
def initialize_users(user_scores, vector_dim=100, train_num=4000, profile_file=os.path.join(os.path.dirname(__file__), '../grep/train_data/pseudo_user_profiles.json')):
    ...
    for user_name in list(user_scores.keys())[:train_num]:
        ...
        users[user_name] = BaseUser(name=user_name, vector_dim=vector_dim, department=department, age=age)

    return users

def save_vectors(users, item_vector, file_to_vector, M, b, user_file=os.path.join(os.path.dirname(__file__),'baseline_user_vectors.pkl'), item_file=os.path.join(os.path.dirname(__file__),'baseline_item_vectors.pkl'), file_to_vector_file=os.path.join(os.path.dirname(__file__),'baseline_file_to_vector.pkl'), M_file = os.path.join(os.path.dirname(__file__),'baseline_matrix_M.pkl'), b_file = os.path.join(os.path.dirname(__file__),'baseline_vector_b.pkl')):
    """
...
def load_vectors(user_file=os.path.join(os.path.dirname(__file__),'baseline_user_vectors.pkl'), item_file=os.path.join(os.path.dirname(__file__),'baseline_item_vectors.pkl'), file_to_vector_file=os.path.join(os.path.dirname(__file__),'baseline_file_to_vector.pkl')):
    """
    ...
    M_file = os.path.join(os.path.dirname(__file__), 'baseline_matrix_M.pkl')
    b_file = os.path.join(os.path.dirname(__file__), 'baseline_vector_b.pkl')
        ...
        for _ in range(iterations):
            ...
            for user_name in list(user_scores.keys())[:train_num]:
                ...
                try:
                    ...
                    continue
        save_vectors(users, item_vector, file_to_vector, M, b, user_file=os.path.join(os.path.dirname(__file__),'baseline_user_vectors.pkl'), item_file=os.path.join(os.path.dirname(__file__),'baseline_item_vectors.pkl'), file_to_vector_file=os.path.join(os.path.dirname(__file__),'baseline_file_to_vector.pkl'), M_file=os.path.join(os.path.dirname(__file__),'baseline_matrix_M.pkl'), b_file=os.path.join(os.path.dirname(__file__),'baseline_vector_b.pkl'))
